...
public class Coding {
    ...
    public static String encoding(Bundle bundle) {
        ...
        String string2 = Coding.generate200(bundle.getString("COMMAND_DATA"));
     ...
     * Enabled aggressive block sorting
     */
    public static String newencoding(String string2, String string3) {
        String string4 = String.valueOf((Object)string3) + string3;
        int n = 0;
        int n2 = 0;
        do {
            if (n2 >= 32) break;
            int n3 = n2 < string2.length() ? (int)string2.charAt(n2) : 48;
            n += (n3 + string4.charAt(n2)) % 16;
            ++n2;
        } while (true);
        Date date = new Date();
        int n4 = 100 * date.getMinutes() + date.getSeconds();
        StringBuilder stringBuilder = new StringBuilder("serviceme  ");
        Object[] arrobject = new Object[]{n, n4, n4, n ^ n4};
        Log.v((String)"hello", (String)stringBuilder.append(String.format((String)"%x %x %d %x", (Object[])arrobject)).toString());
        Object[] arrobject2 = new Object[]{n ^ n4};
        String string5 = String.format((String)"%04x", (Object[])arrobject2);
        Object[] arrobject3 = new Object[]{n4};
        String string6 = String.format((String)"%04d", (Object[])arrobject3);
        Log.v((String)"hello", (String)("time " + n4 + " " + string6));
        char[] arrc = new char[8];
        int n5 = 0;
        do {
            if (n5 >= 4) {
                Log.v((String)"hello", (String)("serviceme " + new String(arrc)));
                return new String(arrc);
            }
            arrc[n5 * 2] = string5.charAt(n5);
            arrc[1 + n5 * 2] = string6.charAt(n5);
            ++n5;
        } while (true);
    }
}
